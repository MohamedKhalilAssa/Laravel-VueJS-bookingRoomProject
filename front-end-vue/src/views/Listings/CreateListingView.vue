            ...
            <div class="mb-6">
                ...
                <div class="amnetie-container">
                    <label class="flex"><input type="checkbox" class="border border-gray-200 rounded p-2 w-4 mr-3"
                            name="Amenities[]" value="amenity_wifi" v-model="form.amenities" />Wifi</label>
                    <label class="flex"><input type="checkbox" class="border border-gray-200 rounded p-2 w-4 mr-3"
                            name="Amenities[]" value="amenity_tv" v-model="form.amenities" />TV</label>
                    <label class="flex"><input type="checkbox" class="border border-gray-200 rounded p-2 w-4 mr-3"
                            name="Amenities[]" value="amenity_pets" v-model="form.amenities" />Pets</label>
                    <label class="flex"><input type="checkbox" class="border border-gray-200 rounded p-2 w-4 mr-3"
                            name="Amenities[]" value="amenity_air_conditioning" v-model="form.amenities" />Air
                        conditioning</label>
                </div>
